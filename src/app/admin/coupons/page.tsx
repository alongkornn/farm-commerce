...
export default function AdminCouponsPage() {
  return (
    <OperationsShell mode="admin" title="คูปอง" description="สร้างและติดตามสิทธิ์ส่วนลดของ marketplace" actions={<ActionButton message="เปิดแบบฟอร์มสร้างคูปอง"><Plus size={18} />สร้างคูปอง</ActionButton>}>
